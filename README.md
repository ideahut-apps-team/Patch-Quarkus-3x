...
* Dibutuhkan untuk membuat __Native Image__ (terkait dengan library eksternal yang dibutuhkan oleh library __Ideahut__).
...
* IDEAHUT
    ...
    --initialize-at-build-time=net.ideahut.quarkus.api,
    --initialize-at-build-time=net.ideahut.quarkus.init,
...
* HIBERNATE
    ...
    --initialize-at-run-time=org.hibernate.type.format.jackson.Jackson3JsonFormatMapper,
    --initialize-at-run-time=org.hibernate.type.format.jackson.Jackson3XmlFormatMapper,
    ```
* QUARTZ
    ```md
